...
const BattleInfo = ({ hamster1, hamster2, fetchData }) => {
    ...
    async function postMatch(winnerId, loserId) {
        ...
        const Response1 = await fetch(`api/matches`, {
            method: 'POST', headers: {
                'Content-type': 'application/json'
    ...
    return (
        <main>
            <section className="wrapper">
                ...
                <p className="vote">Choose image to vote for hamster</p>
                <div className="buttonwrapper">
                    <Link to='/Battle'>
                        <p onClick={() => {
                            fetchData();
                            setShowPopUp(false)
                        }}>Click for the next battle</p>
                    </Link>
                </div>
